...
public class User {
    ...
    @Column(name = "character_gender") private String characterGender;
    @Column(name = "character_hair_style")  private String characterHairStyle;
    @Column(name = "character_hair_color")  private String characterHairColor;
    @Column(name = "character_face_style")  private String characterFaceStyle;
    @Column(name = "character_outfit_style") private String characterOutfitStyle;
